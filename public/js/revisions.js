  ...
  $("#save-button").on("click", function() { 
    ...
    $.post("http://" + SERVER + ":" + NODEPORT + "/save_file", { revision : revCode,  file : fileName }, function(data) {
      if (data.code != undefined) {
        ...
        $("#myTabContent").prepend('<div class="alert alert-dismissible alert-success"><button type="button" class="close" data-dismiss="alert">×</button><strong><p>Done!</p></strong> <p>Revision file saved</p></div>');
      }     
    });
  });
});
